            ...
            <div class="multinav-scroll" style="height: 100%;">
                ...
                <ul class="sidebar-menu" data-widget="tree">
                    ...
                    <li title="Support"><a href="{{ route('telemedicine.index') }}"><i
                        ...
                        <form action="{{ route('telemedicine.index') }}" method="GET" class="d-none">
                            @csrf
                        </form>
                    </li>
                    ...
                    <li class="treeview">
                        ...
                        <ul class="treeview-menu">
                            ...
                            <li><a href="ecommerce_cart.html"><i class="icon-Commit"><span
                                            class="path1"></span><span class="path2"></span></i>Products Cart</a>
                            </li>
                            <li><a href="ecommerce_products_edit.html"><i class="icon-Commit"><span
                                            class="path1"></span><span class="path2"></span></i>Products Edit</a>
                            </li>
                            <li><a href="ecommerce_details.html"><i class="icon-Commit"><span
                                            class="path1"></span><span class="path2"></span></i>Product Details</a>
                            </li>
                    ...
                    <li class="treeview">
                        ...
                        <ul class="treeview-menu">
                            ...
                            <li><a href="ui_dropdown_grid.html"><i class="icon-Commit"><span
                                            class="path1"></span><span class="path2"></span></i>Dropdown Grid</a>
                            </li>
                            <li><a href="ui_progress_bars.html"><i class="icon-Commit"><span
                                            class="path1"></span><span class="path2"></span></i>Progress Bars</a>
                            </li>
                    ...
                    <li class="treeview">
                        ...
                        <ul class="treeview-menu">
                            ...
                            <li><a href="icons_feather.html"><i class="icon-Commit"><span class="path1"></span><span
                                            class="path2"></span></i>Feather Icon</a></li>
                ...
                <div class="sidebar-widgets">
                    <div class="copyright text-start m-25">
                        <p><strong class="d-block">Coup Admin Dashboard</strong> © 2025 All Rights Reserved</p>
                    </div>
                </div>
            </div>
        </div>
