	...
	<aside class="control-sidebar">
		...
		<div class="tab-content">
			...
			<div class="media py-10 px-0">
				...
				<img src="../{{asset('assets')}}/images/avatar/1.html" alt="...">
				</a>
			...
			<div class="media py-10 px-0">
				...
				<img src="../{{asset('assets')}}/images/avatar/2.html" alt="...">
				</a>
				<div class="media-body">
				<p class="fs-16">
			...
			<div class="media py-10 px-0">
				...
				<img src="../{{asset('assets')}}/images/avatar/3.html" alt="...">
				</a>
				<div class="media-body">
				<p class="fs-16">
			...
			<div class="media py-10 px-0">
				...
				<img src="../{{asset('assets')}}/images/avatar/4.html" alt="...">
				</a>
				<div class="media-body">
				<p class="fs-16">
					<a class="hover-primary" href="#"><strong>Evan</strong></a>
...
<!-- ./wrapper -->
	...
	<script src="{{asset('assets')}}/{{asset('assets')}}/vendor_components/apexcharts-bundle/dist/apexcharts.js"></script>
	<script src="{{asset('assets')}}/{{asset('assets')}}/vendor_components/jvectormap/lib2/jquery-jvectormap-2.0.2.min.js"></script>
	<script src="{{asset('assets')}}/fastly.jsdelivr.net/npm/echarts%405.5.1/dist/echarts.min.js"></script>
